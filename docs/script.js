...
const productos = [
    {
      ...
      descripción: 'Llavero del sticker de un gato naranja triste.',
      precio: 32.00,
      imagen: 'cat1.jpg'
    },
    {
      nombre: 'Llavero de gato juzgón',
      descripción: 'Llavero del sticker de un gato naranja juzgando con la mirada.',
      precio: 29.99,
      imagen: 'cat2.webp'
    },
    {
      nombre: 'Llavero de gato sorprendido',
      descripción: 'Llavero del sticker de un gato bicolor sorprendido.',
      precio: 35.00,
      imagen: 'cat3.webp'
    },
    {
      nombre: 'Llavero de gato Chad',
      descripción: 'Llavero del sticker de un gato naranja con el filtro de Chad.',
      precio: 49.99,
      imagen: 'cat4.webp'
    }
  ];
